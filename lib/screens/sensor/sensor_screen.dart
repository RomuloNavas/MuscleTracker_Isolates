...
class _SensorScreenState extends State<SensorScreen> {
  ...
  Widget buildSensorBatteryIndicator(int battery, BuildContext context) {
    return Row(
      children: [
        Text(
          '$battery%',
        ...
        buildBatteryIndicatorIcon(batteryLevel: battery),
      ],
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: Column(
          children: [
            const AppHeaderInfo(
              title: 'Serial Number of yours and found sensors must coincide',
                                      ...
                                      FutureBuilder(
                                          ...
                                          builder: (context,
                                            ...
                                            if (snapshot.connectionState ==
                                                ...
                                                snapshot.hasData) {
                                              return buildSensorBatteryIndicator(
